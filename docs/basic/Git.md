...
- [1 Git 简介](#1-git-简介)
  - [1.1 Git 与 SVN 区别](#11-git-与-svn-区别)
  - [1.2 Git 与 Github](#12-git-与-github)
- [2 Git 安装配置](#2-git-安装配置)
  - [2.1 Git 配置](#21-git-配置)
- [3 Git 工作流程](#3-git-工作流程)
- [4 Git 工作区、暂存区和版本库](#4-git-工作区暂存区和版本库)
  - [4.1 工作区、暂存区和版本库之间的关系](#41-工作区暂存区和版本库之间的关系)
- [5 Git 创建仓库](#5-git-创建仓库)
- [6 Git 基本命令](#6-git-基本命令)
  - [6.1 创建仓库](#61-创建仓库)
  - [6.2 提交与修改](#62-提交与修改)
  - [6.3 提交日志](#63-提交日志)
  - [6.4 远程操作](#64-远程操作)
- [6.5 Git 文件状态](#65-git-文件状态)
- [7 Git 分支管理](#7-git-分支管理)
  - [7.1 创建与切换分支](#71-创建与切换分支)
  - [7.2 查看分支](#72-查看分支)
  - [7.3 合并分支](#73-合并分支)
  - [7.4 删除分支](#74-删除分支)
  - [7.5 最常用分支命令](#75-最常用分支命令)
  - [7.6 完整工作流程](#76-完整工作流程)
    - [7.6.1 永远从最新主分支开新功能](#761-永远从最新主分支开新功能)
    - [7.6.2 创建你的功能分支](#762-创建你的功能分支)
    - [7.6.3 在分支上正常写代码、提交](#763-在分支上正常写代码提交)
    - [7.6.4 写完了，合并回主分支](#764-写完了合并回主分支)
    - [7.6.5 合并完，删除旧分支](#765-合并完删除旧分支)
  - [7.7 主分支被改，怎么同步到你的分支？](#77-主分支被改怎么同步到你的分支)
  - [7.8 遇到冲突怎么办？](#78-遇到冲突怎么办)
  - [7.9 远程分支操作](#79-远程分支操作)
    - [7.9.1 把本地分支发到远程](#791-把本地分支发到远程)
    - [7.9.2 拉取别人创建的远程分支](#792-拉取别人创建的远程分支)
    - [7.9.3 删除远程分支](#793-删除远程分支)
- [8 Git 查看提交历史](#8-git-查看提交历史)
  - [8.1 git log](#81-git-log)
  - [8.2 git blame](#82-git-blame)
- [9 Git 恢复和回退](#9-git-恢复和回退)
  - [9.1 git checkout](#91-git-checkout)
  - [9.2 git reset](#92-git-reset)
  - [9.3 git revert](#93-git-revert)
  - [9.4 git reflog](#94-git-reflog)
  - [9.5 示例](#95-示例)
- [10 Git 标签](#10-git-标签)
- [10 Git Flow](#10-git-flow)
  - [10.1 Git Flow 安装](#101-git-flow-安装)
  - [10.2 Git Flow 工作流程](#102-git-flow-工作流程)
- [11 Git 进阶操作](#11-git-进阶操作)
  - [11.1 Git Stash](#111-git-stash)
  - [11.2 Git Rebase](#112-git-rebase)
  - [11.3 Git Cherry-Pick](#113-git-cherry-pick)
- [12 Git 远程仓库](#12-git-远程仓库)
  - [12.1 **关联远程仓库**](#121-关联远程仓库)
  - [12.2 **验证是否关联成功**](#122-验证是否关联成功)
  - [12.3 **常见问题解决**](#123-常见问题解决)
  - [12.4 **提取远程仓库**](#124-提取远程仓库)
- [13 Git 服务器搭建](#13-git-服务器搭建)
  - [13.1 使用裸存储库（Bare Repository）](#131-使用裸存储库bare-repository)
- [14 Sourcetree](#14-sourcetree)
- [15 VSCode中操作（GUI操作）](#15-vscode中操作gui操作)
    - [15.1 **初始化或打开 Git 仓库**](#151-初始化或打开-git-仓库)
    - [15.2 **基本操作流程**](#152-基本操作流程)
    - [15.3 **其他常用操作**](#153-其他常用操作)
    - [15.4 **配置 Git 信息**](#154-配置-git-信息)
- [16 GUI图标](#16-gui图标)
- [17 分支](#17-分支)
- [18 GUI分支](#18-gui分支)
- [19 常用命令](#19-常用命令)
  - [19.1 **仓库初始化与配置**](#191-仓库初始化与配置)
  - [19.2 **文件暂存与提交**](#192-文件暂存与提交)
  - [19.3 **分支管理**](#193-分支管理)
  - [19.4 **远程仓库操作**](#194-远程仓库操作)
  - [19.5 **版本回退与历史查看**](#195-版本回退与历史查看)
  - [19.6 **标签管理（用于版本发布）**](#196-标签管理用于版本发布)
  - [19.7 **其他常用命令**](#197-其他常用命令)
  - [19.8 **使用建议**](#198-使用建议)

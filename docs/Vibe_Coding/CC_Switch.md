...
CC Switch 提供一个统一的图形界面，让你可以：

- 保存多套 API 配置，点一下即可切换，无需手动编辑 JSON
- 同时管理 Claude Code、Codex、Gemini CLI、OpenCode、OpenClaw 五款工具
- 内置高性能 HTTP 代理，支持自动故障转移与请求监控
- 可视化添加、编辑和同步 MCP 服务器配置
- 实时查看 Token 消耗与 API 费用
- 自动备份配置，防止误操作导致数据丢失

# 安装
GitHub Releases: https://github.com/farion1231/cc-switch/releases/latest 下载对应平台的安装包。
...
![image.png](https://www.runoob.com/wp-content/uploads/2026/03/3f634726-617d-43a7-9040-a4acaaca9433.png)

点击右上角的 + ，从内置预设中选择（如官方 Anthropic API、DeepSeek、阿里百炼等），或手动填写以下信息：

![image.png](https://www.runoob.com/wp-content/uploads/2026/03/6e4e3a28-1f43-446a-a939-c08eb195ba43.png)

![image.png](https://www.runoob.com/wp-content/uploads/2026/03/11305e0d-1ca7-46f6-83d6-cec24c4f46bd.png)

在列表中点击目标 Provider，再点击「启用」，CC Switch 会自动将配置写入对应 CLI 工具的配置文件:

![image.png](https://www.runoob.com/wp-content/uploads/2026/03/0d05c29d-f2c4-4c42-8afc-88ed80937a30.png)
